...
def all_tools() -> list[Tool]:
    ...
    from .file import edit, read, undo, write
    ...
    tools += [bash, read, write, edit, undo, glob, grep, repo_map, eval_tool, web_search, web_extract,
              github, git, inspect_image, show_image, todo, ask, delegate, preset_create,
